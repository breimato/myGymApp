...
@section('content')
    ...
    <form class="form-signin" style="width: 250px; display: block; margin: 0 auto 10px auto;" method="post" accept-charset="UTF-8" action="/buscar_usuario">
        @csrf
        <input class="form-control" style="text-align: center; margin-bottom: 20px" type="text" id="name" name="name" placeholder="Usuario" required autofocus>
        <input class="form-control" style="text-align: center; margin-bottom: 20px" type="password" id="login-password" name="login-password" placeholder="Contraseña" required>
        ...
        <a href="{{ route('register_view') }}" class="btn btn-secondary btn-block" style="margin-bottom: 20px; padding-left: 25px; padding-right: 25px">Registrate!</a>
